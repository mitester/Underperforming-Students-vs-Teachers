...
public:
    ...
    static QPixmap* PIC_0;  //preloaded pictures of kelvin
    ...
    TimeVariant::Type getType() const;  //virtual function required by superclasses
    void update();  //implementation of the pure virtual update()
